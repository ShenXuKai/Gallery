 ...
 */
package io.yoofn.picker.widget;
...
import io.yoofn.picker.ImageSelectActivity;
import io.yoofn.picker.PictureDetailActivity;
import io.yoofn.picker.R;
import io.yoofn.picker.control.SelectedUriCollection;
import io.yoofn.picker.model.Picture;
...
public class GridViewItemRelativeLayout extends RelativeLayout {
    ...
    public void setImageView(ImageView imageView, ImageView imageCheck, SelectedUriCollection mCollection) {
        ...
        this.imageCheck.setOnClickListener(v -> {
        ...
        this.imageView.setOnClickListener(v -> {
            ...
            intent.putExtra("aa", item.buildContentUri());
            intent.putExtra("bb", this.mCollection.isSelected(item.buildContentUri()));
            intent.putExtra("ee", this.mCollection.isCountOver());
